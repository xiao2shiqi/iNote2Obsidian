...
def test_slug_and_filename_stability() -> None:
    filename = build_md_filename("2026-03-04T01:02:03+00:00")
    assert filename == "2026-03-04 01-02-03.md"
...
def test_frontmatter_and_asset_reference() -> None:
    ...
    assert rendered.md_rel_path == "AppleNotes/Diary/2026-03-03 00-00-00.md"
